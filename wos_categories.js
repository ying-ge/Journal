...
const WOSCategories = {
    ...
    '医学与健康': {
        ...
        keywords: [
            ...
            'NEUROLOGY', 'BRAIN', 'NEURAL', 'NEUROINFLAMMATION',
            ...
            'ENDOCRINOLOGY', 'DIABETES', 'DIABET', 'HORMONE',
            'INFECTIOUS', 'INFECTION', 'VIRUS', 'VIRAL', 'BACTERIA',
            'IMMUNOLOGY', 'IMMUNE', 'AUTOPHAGY',
            'PATHOLOGY', 'RADIOLOGY', 'PHARMACOLOGY',
            'SURGERY', 'SURGICAL',
            'PEDIATRICS', 'CHILD', 'INFANT',
            'OBSTETRICS', 'GYNECOLOGY', 'REPRODUCTION', 'PREGNANCY',
            'GERIATRICS', 'AGING', 'ELDERLY',
            'PSYCHIATRY', 'PSYCHOLOGY', 'MENTAL', 'ALZHEIMERS',
            'ANESTHESIA', 'PAIN',
            'EMERGENCY', 'CRITICAL', 'INTENSIVE',
            'NURSING', 'CARE',
            'PUBLIC HEALTH', 'EPIDEMIOLOGY',
            'PHARMACY', 'PHARMA', 'DRUG', 'THERANOSTICS',
            'REHABILITATION', 'THERAPY', 'TREATMENT', 'OBESITY',
...
function getKeywordPriority(keyword) {
    ...
    if (['CANCER', 'ONCOLOGY', 'LEUKEMIA', 'TUMOR', 'TUMOUR',
         ...
         'BRAIN', 'NEUROLOGY', 'NEUROSURGERY', 'NEUROINFLAMMATION',
         'BLOOD', 'HEMATOLOGY',
         'BONE', 'ORTHOPEDIC', 'ORTHOPAEDIC',
         'DIABETES', 'DIABET', 'ARTHRITIS',
